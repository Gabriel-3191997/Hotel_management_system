        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mt-6 sm:mt-8">
            ...
            <div className="bg-white w-full h-auto">
              ...
              />
              <p className="text-lg py-5 font-sans text-left capitalize mx-0 font-medium">
                <Link to="/bookings/boluvard-palace">boluvard palace</Link> <br />
                <span className="font-sans font-normal text-sm">
                  12 Street Sinkor
                </span>
              </p>
        ...
        <div className="bg-white h-auto mt-16 sm:mt-20 md:mt-24 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mt-6 sm:mt-8">
            <div className="bg-white w-full h-auto">
              ...
              <p className="text-lg py-5 font-sans text-left capitalize mx-0 font-medium">
                <Link to="/bookings/bella-casa-hotel">bella casa</Link> <br />
                <span className="font-sans font-normal text-sm">
                  3rd Street Sinkor
                </span>
              </p>
            ...
            <div className="bg-white w-full h-auto">
              ...
              <p className="text-lg py-5 font-sans text-left capitalize mx-0 font-medium">
                <Link to="/bookings/sinkor-palace-hotel">sinkor palace hotel</Link>{" "}
                <br />
                <span className="font-sans font-normal text-sm">
                  congo town
                </span>
            ...
            <div className="bg-white w-full h-auto">
              ...
              />
              <p className="text-lg py-5 font-sans text-left capitalize mx-0 font-medium">
                <Link to="/bookings/fammington-hotel">fammington hotel</Link> <br />
                <span className="font-sans font-normal text-sm">
                  12 Street Sinkor
                </span>
              </p>
